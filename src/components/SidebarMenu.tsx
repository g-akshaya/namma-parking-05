import { UserIcon, WalletIcon, ClockIcon, InfoIcon, LogOutIcon, XIcon, CalendarCheckIcon } from 'lucide-react';
...
const menuItems = [
  ...
  { icon: <ClockIcon className="w-5 h-5" />, label: 'Parking History', path: '/parking-history' },
  { icon: <CalendarCheckIcon className="w-5 h-5" />, label: 'Booking Status', path: '/booking-status' },
  { icon: <InfoIcon className="w-5 h-5" />, label: 'FAQ', path: '/faq' },
